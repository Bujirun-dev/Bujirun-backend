...
/**
 * 마이그레이션 실행 상태를 메모리에 보관.
 * 서버 재시작 시 초기화됨 (단발성 확인 용도).
 */
@Component
@Getter
public class MigrationStatusHolder {

    private volatile MigrationStatus status = MigrationStatus.IDLE;
    private volatile MigrationService.MigrationResult lastResult;
    ...
    public void markCompleted(MigrationService.MigrationResult result) {
