...
/**
 * TourAPI 개요(overview) 백필(enrichWithTourApiOverview) 실행 상태를 메모리에 보관.
 * 서버 재시작 시 초기화됨 (단발성 확인 용도).
 */
@Component
@Getter
public class TourApiOverviewStatusHolder {

    private volatile MigrationStatus status = MigrationStatus.IDLE;
    private volatile MigrationService.TourApiOverviewResult lastResult;
    ...
    public void markCompleted(MigrationService.TourApiOverviewResult result) {
