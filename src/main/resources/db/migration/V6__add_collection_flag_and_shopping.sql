-- V6__add_collection_flag_and_shopping.sql

-- =============================================================
-- [1] tour_spots에 도감 여부 컬럼 추가
-- =============================================================

ALTER TABLE tour_spots ADD COLUMN IF NOT EXISTS is_collection BOOLEAN NOT NULL DEFAULT false;
